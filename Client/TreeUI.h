...
public:
    ...
    vector<TreeNode*> GetTreeVec() { return m_vecChild; }
...
private:
    ...
    bool                m_bUseDropToSceneOutliner;
...
public:    
    ...
    void UseDragDropToSceneOutliner(bool _b) { m_bUseDropToSceneOutliner = _b; }
