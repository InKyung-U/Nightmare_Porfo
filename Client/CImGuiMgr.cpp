...
void CImGuiMgr::CreateUI()
{
    ...
    // TileMapUI
    TileMapUI* pTileMap = new TileMapUI;
    pTileMap->Deactivate();
    m_mapUI.insert(make_pair(pTileMap->GetName(), pTileMap));
    ...
    // TileSelectMapUI
    TileSelectUI* pTileSelect = new TileSelectUI;
    pTileSelect->Deactivate();
    pTileSelect->SetModalUI(true);
    m_mapUI.insert(make_pair(pTileSelect->GetName(), pTileSelect));
