...
CParticleSystem::CParticleSystem()
	...
	, m_fStartSpeed(300.f)
	, m_fEndSpeed(200.f)
	, m_vStartColor(Vec4(0.8f, 1.f, 1.f, 1.f))
	, m_vEndColor(Vec4(0.8f, 1.f, 1.f, 0.f))
	, m_vStartScale(Vec3(15.f, 15.f, 1.f))
	, m_vEndScale(Vec3(15.f, 15.f, 1.f))
	, m_fParticleCreateDistance(50.f)
	, m_fParticleCreateTerm(2.f)
{
